...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (fullPath === 'me' && method === 'GET') {
      return json(res, { email: user.email });
    }

    if (fullPath === 'dashboard' && method === 'GET') {
    ...
    if (fullPath === 'inquiries' && method === 'GET') {
